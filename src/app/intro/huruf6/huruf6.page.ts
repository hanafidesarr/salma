...
@Component({
  selector: 'app-huruf6',
  templateUrl: './huruf6.page.html',
  styleUrls: ['./huruf6.page.scss'],
})
export class Huruf6Page implements OnInit {
  ...
  array: any = [
    ...
    {name: "o-hitam", url: "assets/icon/o-hitam.png", voice: "assets/mp3/om4a"},
    {name: "o-hitam", url: "assets/icon/o-hitam.png", voice: "assets/mp3/om4a"},
    {name: "o-hitam", url: "assets/icon/o-hitam.png", voice: "assets/mp3/om4a"},
