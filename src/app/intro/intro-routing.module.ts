...
const routes: Routes = [
  ...
  {
    path: 'huruf4',
    loadChildren: () => import('./huruf4/huruf4.module').then( m => m.Huruf4PageModule)
  },
  {
    path: 'huruf5',
    loadChildren: () => import('./huruf5/huruf5.module').then( m => m.Huruf5PageModule)
  },
  {
    path: 'huruf6',
  ...
  {
    path: 'huruf8',
    loadChildren: () => import('./huruf8/huruf8.module').then( m => m.Huruf8PageModule)
  },
  {
    path: 'huruf9',
    loadChildren: () => import('./huruf9/huruf9.module').then( m => m.Huruf9PageModule)
  }
];
